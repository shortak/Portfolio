...
Examples of structs in C and C++ can be found in the [Point.c](Portfolio/Projects/CS_Fundamentals_Using_C%2B%2B/Point.c) and [Point.cpp](Portfolio/Projects/CS_Fundamentals_Using_C%2B%2B/Point.cpp) files.
